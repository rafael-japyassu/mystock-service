...
var FindProductsService = /** @class */ (function () {
    function FindProductsService() {
    }
    FindProductsService.prototype.execute = function (_a) {
        var name = _a.name, _b = _a.description, description = _b === void 0 ? '' : _b, _c = _a.category_id, category_id = _c === void 0 ? '' : _c;
...
exports.default = FindProductsService;
