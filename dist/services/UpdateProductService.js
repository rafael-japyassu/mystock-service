...
var UpdateProductService = /** @class */ (function () {
    ...
    UpdateProductService.prototype.execute = function (_a) {
        var id = _a.id, name = _a.name, description = _a.description, category_id = _a.category_id, price = _a.price, stock = _a.stock;
        return __awaiter(this, void 0, void 0, function () {
            var productRepository, productUpdated, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 3, , 4]);
                        productRepository = typeorm_1.getRepository(Product_1.default);
                        return [4 /*yield*/, productRepository.update({ id: id }, {
                                name: name,
